...
export const signalFormSchema = z.object({
  ...
  symbol: z.string(),
  entry_range: z.string(),
  stop_loss: z.coerce.number().gte(0, "Stop loss must be more than or equal 0"),
  take_profit_1: z.coerce
    .number()
    .gte(0, "Take Profit must be more than or equal 0"),
  take_profit_2: z.coerce
    .number()
    .gte(0, "Take Profit must be more than or equal 0"),
  take_profit_3: z.coerce
    .number()
    .gte(0, "Take profit must be more than or equal 0"),
  take_profit_4: z.coerce
    .number()
    .gte(0, "Take profit must be more than or equal 0"),
  take_profit_5: z.coerce
    .number()
    .gte(0, "Take profit must be more than or equal 0"),
